...
class RN(nn.Module):
    def __init__(self, hyp, qdict_size, adict_size, extraction=False):
        ...
        self.text = QuestionEmbedModel(qdict_size, embed=hyp["lstm_word_emb"], hidden=hidden_size)

        # RELATIONAL LAYER
        self.rl_in_size = hyp["rl_in_size"]
        self.rl_out_size = adict_size
